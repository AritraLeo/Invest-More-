...
<head>
    ...
    <link rel="favicon" type="image/png" href="images/Invest_More_Logo/favicon.png">
...
<body>
    <?php
    //$t = file_get_contents('http://mydynamicsitetests.rf.gd/ChatBot_Production/Chatbot_tasks/Chatbot_gitpush/');
    ...
    <nav class="navbar">
        ...
        <div class="navbar_menu">
            ...
            <a href="Login/register.php" class="navbar_link">REGISTER</a>
            <a href="Login/login.php" class="navbar_link">LOGIN</a>
            <a href="#motive" class="navbar_link">MOTIVE</a>
            <a href="Utility/Plans.php" class="navbar_link">PLANS</a>
            <a href="#about_us" class="navbar_link">ABOUT US</a>
        </div>
    </nav>


    <div style="display:none;" id="dep_alert" class='alert alert-danger'><span class='glyphicon glyphicon-remove'>Please Register youreself to choose a Plan!</span></div>
    ...
    <div class="hero">
        <div class="hero_content">
            ...
            <a href="../Login/register.php" class="button animate-hero"><b>REGISTER</b></a>
        </div>
    </div>
    ...
    <div class="services" id="motive">
        <div class="services_container">
            ...
            <!-- Motive Image -->
            <!-- <div>
        <img src="../images/background_image_motive.jpeg" alt="Our Motive" class="services_img animate-img" />
    ...
    <div class="memberships" id="plans">
                ...
                <div class="card-body">
                    ...
                    <div class="card-element-hidden-basic">
                        <ul class="card-element-container">
                            ...
                            <a class="btn btn-basic" style="text-decoration: none;" id="deposit">Deposit</a>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card-element-hidden-standard">
                        <ul class="card-element-container">
                            ...
                            <a class="btn btn-standard" style="text-decoration: none;" id="deposit">Deposit</a>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="">
            <a class="button bottom-0 end-0" style="justify-content: left;" href="Utility/Plans.php">View More</a>
        </div>
    </div>
        ...
        <div class="email_content">
            ...
            <form action="MailSending/ContactMail.php" method="POST" class="animate-email">
                <div class="form_wrap">
                    ...
                    <button class="button" type="submit" name="submit" id="send">Send!</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="footer">
        ...
        <div class="footer_wrapper">
            ...
            <div class="footer_links">
                ...
                <a href="./Welcome/terms_and_conditions.php" class="footer_link">T&C</a>
                <a href="./Welcome/privacy_policy_refund.php" class="footer_link">Privacy&Refund Policy</a>
